    ...
    >
      ...
      >
        <div class="center-container" v-if="item.i == 0">
          ...
          <div :class="changeCss ? 'office-container-Width' : 'office-container-Height'">
            <div class="no-drag">
              <OfficePanel class="panel"></OfficePanel>
            </div>
          </div>
        </div>
...
import OfficePanel from '@/components/office_panel.vue';
...
<style>
.office-container-Height {
  position: absolute;
  width: calc(100vh / 827 * 1126);
  height: 100vh;
  background: url("../static/image/office.jpg") no-repeat center center;
  background-size: contain;
}

.office-container-Width {
  position: absolute;
  width: 75vw;
  height: calc(75vw / 1126 * 827);
  background: url("../static/image/office.jpg") no-repeat center center;
  background-size: contain;
}
</style>
