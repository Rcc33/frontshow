    ...
    >
      ...
      >
        <div class="center-container" v-if="item.i == 0">
          ...
          <div
            :class="changeCss ? 'meetingRoom-one-container-Width' : 'meetingRoom-one-container-Height'"
          >
            <div class="no-drag">
              <MeetingRoomOnePanel class="panel"></MeetingRoomOnePanel>
            </div>
          </div>
        </div>
...
import MeetingRoomOnePanel from '@/components/meetingRoom_one_panel.vue';
...
<style>
.meetingRoom-one-container-Height {
  position: absolute;
  width: calc(100vh / 926 * 1696);
  height: 100vh;
  background: url("../static/image/meetingRoom_one.jpg") no-repeat center center;
  background-size: contain;
}

.meetingRoom-one-container-Width {
  position: absolute;
  width: 75vw;
  height: calc(75vw / 1696 * 926);
  background: url("../static/image/meetingRoom_one.jpg") no-repeat center center;
  background-size: contain;
}
</style>
