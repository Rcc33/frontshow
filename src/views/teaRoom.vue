    ...
    >
      ...
      >
        <div class="center-container" v-if="item.i == 0">
          ...
          <div :class="changeCss ? 'teaRoom-container-Width' : 'teaRoom-container-Height'">
            <div class="no-drag">
              <TeaRoomPanel class="panel"></TeaRoomPanel>
            </div>
          </div>
        </div>
...
import TeaRoomPanel from '@/components/teaRoom_panel.vue';
...
<style>
.teaRoom-container-Height {
  position: absolute;
  width: calc(100vh / 838 * 1083);
  height: 100vh;
  background: url("../static/image/teaRoom.jpg") no-repeat center center;
  background-size: contain;
}

.teaRoom-container-Width {
  position: absolute;
  width: 75vw;
  height: calc(75vw / 1083 * 838);
  background: url("../static/image/teaRoom.jpg") no-repeat center center;
  background-size: contain;
}
</style>
