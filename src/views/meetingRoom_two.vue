    ...
    >
      ...
      >
        <div class="center-container" v-if="item.i == 0">
          ...
          <div
            :class="changeCss ? 'meetingRoom-two-container-Width' : 'meetingRoom-two-container-Height'"
          >
            <div class="no-drag">
              <MeetingRoomTwoPanel class="panel"></MeetingRoomTwoPanel>
            </div>
          </div>
        </div>
...
import MeetingRoomTwoPanel from '@/components/meetingRoom_two_panel.vue';
...
<style>
.meetingRoom-two-container-Height {
  position: absolute;
  width: calc(100vh / 717 * 1389);
  height: 100vh;
  background: url("../static/image/meetingRoom_two.jpg") no-repeat center center;
  background-size: contain;
}

.meetingRoom-two-container-Width {
  position: absolute;
  width: 75vw;
  height: calc(75vw / 1389 * 717);
  background: url("../static/image/meetingRoom_two.jpg") no-repeat center center;
  background-size: contain;
}
</style>
